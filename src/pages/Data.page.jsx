    ...
    return (
        <div className='min-w-[490px]'>
            <section className='mx-20'>
                <div className='bg-data h-[334px] font-bold text-[40px] md:text-[64px] text-white flex flex-row items-end pl-10 pb-5'>
                    DATA
                </div>
                <div className='font-medium text-[17px] md:text-[20.5px] mt-7 pb-10 mb-7 border-b-[3px] border-[#0082CE]'>
                    <p> Lorem ipsum dolor sit amet. Nam dolor incidunt non quidem fugiat At voluptatum dolorum. Ea consequatur deleniti qui temporibus consequatur non dolore voluptas At nobis nostrum est optio quod ut tenetur dolorem. Ad cumque commodi ea voluptatum omnis est internos suscipit sit Quis veritatis? Aut repellendus totam At libero repellat 33 enim perferendis ea tempore autem et exercitationem beatae quo atque culpa id quibusdam voluptatem.</p>
                ...
                <div className='flex flex-col items-start justify-between space-y-20  '>
                    <div className='flex flex-col lg:flex-row items-center justify-center mr-[40px] mb-[30px]'>
                        <div className='flex flex-col items-end lg:w-1/3 mb-[20px]'>
                            ...
                            <div className='bg-[#0082CE] flex flex-row space-x-3 p-4 w-[358px] mt-[-12px]'>
